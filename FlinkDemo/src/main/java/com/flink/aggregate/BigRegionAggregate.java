...
import com.flink.entity.AggregRegionSum;
import com.flink.entity.BigFrom;
import com.flink.entity.IpEntity;
import com.flink.ip.IpUtil;
...
public class BigRegionAggregate implements AggregateFunction<BigFrom, Object, Object> {
  ...
  public Object add(BigFrom bigFrom, Object o) {
    ...
    ConcurrentHashMap<String, AggregRegionSum> baseCreateAccumulator = (ConcurrentHashMap<String, AggregRegionSum>) o;
