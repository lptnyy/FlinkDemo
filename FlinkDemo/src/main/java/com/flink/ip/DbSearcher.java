...
public class DbSearcher
{
     ...
     * db config
    */
    private org.lionsoul.ip2region.DbConfig dbConfig = null;
    ...
    */
    public DbSearcher( org.lionsoul.ip2region.DbConfig dbConfig, String dbFile ) throws FileNotFoundException
    {
     ...
     * @param   dbBinStr
     */
    public DbSearcher(org.lionsoul.ip2region.DbConfig dbConfig, byte[] dbBinStr)
    {
        this.dbConfig = dbConfig;
     ...
     * @throws  IOException
    */
    public org.lionsoul.ip2region.DataBlock memorySearch(long ip) throws IOException
    {
        ...
        return new org.lionsoul.ip2region.DataBlock(city_id, region, dataPtr);
    }
     ...
     * @throws  IOException
    */
    public org.lionsoul.ip2region.DataBlock memorySearch( String ip ) throws IOException
    {
     ...
     * @throws  IOException
    */
    public org.lionsoul.ip2region.DataBlock getByIndexPtr( long ptr ) throws IOException
    {
        raf.seek(ptr);
     ...
     * @throws  IOException
    */
    public org.lionsoul.ip2region.DataBlock btreeSearch( long ip ) throws IOException
    {
     ...
     * @throws  IOException
    */
    public org.lionsoul.ip2region.DataBlock btreeSearch( String ip ) throws IOException
    {
     ...
     * @throws  IOException
    */
    public org.lionsoul.ip2region.DataBlock binarySearch( long ip ) throws IOException
    {
        int blen = IndexBlock.getIndexBlockLength();
