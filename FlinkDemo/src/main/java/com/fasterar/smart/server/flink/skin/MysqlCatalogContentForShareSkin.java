...
public class MysqlCatalogContentForShareSkin extends RichSinkFunction <ConcurrentHashMap<String, CatalogContentDay>>{
    ...
    public void invoke(ConcurrentHashMap<String, CatalogContentDay> value, Context context) throws Exception {
        value.forEach((k,v) ->{
                ...
                if (catalogContent == null) {
                    ...
                    catalogContent.setShares(catalogContent.getShares()+ v.getShares());
                    catalogContent.setShareNumber(catalogContent.getShareNumber() + v.getShareNumber());
