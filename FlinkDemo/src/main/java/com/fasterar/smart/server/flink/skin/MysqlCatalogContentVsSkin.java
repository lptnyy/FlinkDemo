...
public class MysqlCatalogContentVsSkin extends RichSinkFunction <ConcurrentHashMap<String, CatalogContentDay>>{
    ...
    public void invoke(ConcurrentHashMap<String, CatalogContentDay> value, Context context) throws Exception {
        value.forEach((k,v) ->{
                ...
                if (catalogContent == null) {
                    ...
                    catalogContent.setShareVisitors(catalogContent.getShareVisitors()+ v.getShareVisitors());
                    catalogContent.setShareVisitorNumber(catalogContent.getShareVisitorNumber() + v.getShareVisitorNumber());
