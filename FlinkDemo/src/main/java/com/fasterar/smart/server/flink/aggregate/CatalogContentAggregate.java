...
public class CatalogContentAggregate implements AggregateFunction<DataLog, Object, Object> {
...
//        RedisUtil redisUtil = new RedisUtil();
        ...
        if (concurrentHashMap.get(key) != null) {
            ...
            if (dataLog.getInid() ==1) {
                catalogContent.setBrowses(catalogContent.getBrowses() +1);
            }
        } else {
            catalogContent.setCatalogId(dataLog.getTid());
            catalogContent.setBrowses(1);
